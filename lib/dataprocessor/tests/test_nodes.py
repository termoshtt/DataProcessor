...
from .. import nodes
# from ..nodes import DataProcessorNodesError as nodesError
...
class TestValidateLink(unittest.TestCase):
    ...
    def test_fill(self):
        ...
        nodes.validate_link(node_list, node_list[2])
        self.assertEqual(node_list, [{
            "path": "/path/0",
            "parents": ["/path/2"],  # filled
            "children": []
        }, {
            "path": "/path/1",
            "parents": [],
            "children": ["/path/2"]  # filled
        }, {
            "path": "/path/2",
            "parents": ["/path/1"],
            "children": ["/path/0"]
    ...
    def test_remove(self):
        ...
        nodes.validate_link(node_list, node_list[1], silent=True)
        self.assertEqual(node_list, [{
            "path": "/path/0",
            "parents": [],
            "children": ["/path/1"]
...
class TestAdd(TestNodeListAndDir):
    ...
    def test_add(self):
        ...
        nodes.add(node_list, node)  # no raise
        self.assertEqual(node_list, [nodes.normalize(node)])
    ...
    def test_add_raise(self):
        ...
        with self.assertRaises(dpError):
            nodes.add([], {
                "path": "/path/0",
                "type": "homhom",  # invalid type
            })

    def test_add_update(self):
        pass

    def test_add_modest_update(self):
        pass
